...
class DetailsAdapter(val locationInfoList: ArrayList<ConsolidatedWeather>): RecyclerView.Adapter<DetailsAdapter.LocationInfoViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LocationInfoViewHolder, position: Int) {
        ...
        Glide.with(holder.view.context).load(locationInfoList[position].getImageUrl()).into(holder.view.state_image);
